...
**한 줄:** CRM 없이 담당 매장이 1,300개까지 늘어나 누구를 먼저 만나야 할지 스스로 판단하기 어려워진 영업 담당자.
...
**최근 상황 (페인포인트)**
- **회사에 CRM이 없어** 담당 매장 정보·상담 이력을 개인 엑셀과 메모장으로 관리한다
- CS팀에 어떤 문의가 들어왔는지 확인하려면 전화나 메신저로 따로 물어봐야 한다 — 실시간으로 알 방법이 없다
- 매장을 다시 방문할 때 이전에 무슨 이야기를 나눴는지 기록이 없어 매번 처음부터 파악해야 한다
...
- 신입 직원이 POS기를 자주 고장냄
- **Tongss Place에 CRM이 없어서** CS에 여러 번 문의해도 그때그때 새로 설명해야 한다 — 이전 문의
  이력이 연결되지 않아 매번 같은 상황을 처음부터 설명하는 게 번거롭다
